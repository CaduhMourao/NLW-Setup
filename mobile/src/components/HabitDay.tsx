    ...
    return (
        <TouchableOpacity
            className={clsx('rounded-lg border-2 m-1', {
                ...
                ['bg-violet-800 border-violet-600']: amountAccomplishedPercentage > 20 && amountAccomplishedPercentage < 40,['bg-violet-700 border-violet-500']: amountAccomplishedPercentage > 40 && amountAccomplishedPercentage < 60,
